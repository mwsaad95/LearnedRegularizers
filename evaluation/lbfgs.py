...
def lbfgs(x0, energy_func, max_iter=200, tol=1e-4, verbose=False):
    """
    Algorithm: L-BFGS optimization using pytorch-minimize
...
def reconstruct_lbfgs(
    ...
    """Wrapper to use L-BFGS for the inverse problem"""
    ...
    # We must require gradients for the L-BFGS optimizer to work
